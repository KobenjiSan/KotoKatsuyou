...
const teKaraConfig = {
    ...
    sentenceMeaning: (sentence, meaning) => `${Utils.buildPastSentence(sentence, meaning, helperVerb).slice(2)}..`, // Using .. because sentence already includes a period
